...
export const registrarReporteEFOS = async (req, res) => {
  try {
    ...
    // Fecha actual para validar si ya fue registrado este mes
    ...
    if (yaExiste.length > 0) {
      return res.status(409).json({ mensaje: '⚠️ Ya se ha registrado el Reporte EFOS este mes' });
    }
